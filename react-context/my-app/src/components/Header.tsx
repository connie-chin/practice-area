// import { useContext } from 'react'; //do this
// import { CartContext } from './CartContext'; //do this
import { useCart } from './useCart';
import { Link, Outlet } from 'react-router-dom';
import { FaShoppingCart } from 'react-icons/fa';

export function Header() {
  // const { cart } = useContext(CartContext); //destructure whatever property we want from CartContext
  const { cart } = useCart();
  return (
    <div>
